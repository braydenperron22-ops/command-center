...
components.html(
    ...
    (function () {
      ...
      s.textContent = [
        ...
        "    'fog-day':     {top:[168,174,178],bottom:[206,209,210], sun:false,moon:false, clouds:0.30, rain:0, snow:0, fog:1, storm:0, stars:0, heat:0},",
        "    'fog-night':   {top:[50,54,60],   bottom:[80,84,90],    sun:false,moon:false, clouds:0.30, rain:0, snow:0, fog:1, storm:0, stars:0, heat:0},",
        ...
        "    'storm-day':   {top:[35,36,46],   bottom:[68,70,82],    sun:false,moon:false, clouds:1.0,  rain:1.0, snow:0, fog:0, storm:0.6, stars:0, heat:0},",
        "    'storm-night': {top:[18,19,26],   bottom:[38,40,48],    sun:false,moon:false, clouds:1.0,  rain:1.0, snow:0, fog:0, storm:0.6, stars:0, heat:0},",
        "    'snow-day':    {top:[150,163,180],bottom:[213,220,228], sun:false,moon:false, clouds:0.7,  rain:0, snow:1, fog:0, storm:0, stars:0, heat:0},",
        "    'snow-night':  {top:[40,46,58],   bottom:[70,78,92],    sun:false,moon:true,  clouds:0.7,  rain:0, snow:1, fog:0, storm:0, stars:0.25, heat:0},",
        "    'severe-storm-day':  {top:[26,32,26], bottom:[52,60,44],  sun:false,moon:false, clouds:1.0, rain:1.0, snow:0, fog:0, storm:1.0, stars:0, heat:0},",
        "    'severe-storm-night':{top:[14,18,14], bottom:[30,36,26],  sun:false,moon:false, clouds:1.0, rain:1.0, snow:0, fog:0, storm:1.0, stars:0, heat:0},",
        "    'tornado-day':  {top:[20,24,20], bottom:[42,48,36], sun:false,moon:false, clouds:1.0, rain:0.7, snow:0, fog:0, storm:0.5, stars:0, heat:0},",
        "    'tornado-night':{top:[10,13,10], bottom:[24,28,20], sun:false,moon:false, clouds:1.0, rain:0.7, snow:0, fog:0, storm:0.5, stars:0, heat:0},",
        "    'blizzard-day':  {top:[140,148,158],bottom:[188,194,200], sun:false,moon:false, clouds:0.9, rain:0, snow:1, fog:0.45, storm:0, stars:0, heat:0},",
        "    'blizzard-night':{top:[50,56,66],   bottom:[86,92,100],   sun:false,moon:false, clouds:0.9, rain:0, snow:1, fog:0.45, storm:0, stars:0, heat:0},",
        "    'freezing-rain-day':  {top:[58,68,82], bottom:[104,116,128], sun:false,moon:false, clouds:0.95, rain:0.45, snow:0, fog:0, storm:0, stars:0, heat:0},",
        "    'freezing-rain-night':{top:[24,30,40], bottom:[52,60,70],    sun:false,moon:false, clouds:0.95, rain:0.45, snow:0, fog:0, storm:0, stars:0, heat:0},",
        "    'heavy-rain-day':  {top:[42,50,60], bottom:[78,88,98], sun:false,moon:false, clouds:1.0, rain:1.0, snow:0, fog:0, storm:0, stars:0, heat:0},",
        "    'heavy-rain-night':{top:[16,20,26], bottom:[34,40,46], sun:false,moon:false, clouds:1.0, rain:1.0, snow:0, fog:0, storm:0, stars:0, heat:0},",
        "    'heavy-snow-day':  {top:[128,138,152],bottom:[196,204,214], sun:false,moon:false, clouds:0.95, rain:0, snow:1, fog:0, storm:0, stars:0, heat:0},",
        "    'heavy-snow-night':{top:[46,52,64],   bottom:[86,92,102],   sun:false,moon:true,  clouds:0.95, rain:0, snow:1, fog:0, storm:0, stars:0.15, heat:0},",
        "    'wind-warning-day':  {top:[100,150,205],bottom:[192,212,226], sun:true, moon:false, clouds:0.5, rain:0, snow:0, fog:0, storm:0, stars:0, heat:0},",
        "    'wind-warning-night':{top:[16,22,40],   bottom:[34,44,66],    sun:false,moon:true,  clouds:0.5, rain:0, snow:0, fog:0, storm:0, stars:0.6, heat:0},",
        "    'smoke-day':  {top:[196,158,110],bottom:[224,186,132], sun:true, moon:false, clouds:0.05, rain:0, snow:0, fog:0.85, storm:0, stars:0, heat:0, fogTint:'196,140,90'},",
        "    'smoke-night':{top:[40,32,26],   bottom:[64,50,38],    sun:false,moon:true,  clouds:0.05, rain:0, snow:0, fog:0.7, storm:0, stars:0.1, heat:0, fogTint:'120,80,55'},",
        "    'heat-wave-day':  {top:[142,192,232],bottom:[255,238,205], sun:true, moon:false, clouds:0.02, rain:0, snow:0, fog:0, storm:0, stars:0, heat:1},",
        "    'heat-wave-night':{top:[18,26,42],   bottom:[46,42,40],    sun:false,moon:true,  clouds:0.02, rain:0, snow:0, fog:0, storm:0, stars:0.8, heat:0.6},",
        "    'extreme-cold-day':  {top:[152,190,222],bottom:[224,238,246], sun:true, moon:false, clouds:0.08, rain:0, snow:0, fog:0, storm:0, stars:0, heat:0},",
        "    'extreme-cold-night':{top:[6,10,24],    bottom:[20,30,50],    sun:false,moon:true,  clouds:0.06, rain:0, snow:0, fog:0, storm:0, stars:1, heat:0},",
        ...
        "  };",
        "  var HAZARD_TO_STATE = {",
        "    'tornado':'tornado', 'hurricane':'severe-storm', 'tsunami':'severe-storm',",
        ...
        "    var isDay = dataEl.dataset.day === '1'; var golden = dataEl.dataset.golden === '1';",
        "    var hazard = dataEl.dataset.hazard || '';",
        "    if (hazard && HAZARD_TO_STATE[hazard]) {",
        "      var base = HAZARD_TO_STATE[hazard];",
        "      if (base === 'frost') return 'frost';",
        "      var key = base + (isDay ? '-day' : '-night');",
        "      if (STATES[key]) return key;",
        "      return STATES[base] ? base : 'clear-day';",
        "    }",
        "    var code = dataEl.dataset.code || '2';",
        "    if (code === '0') return isDay ? (golden ? 'golden-hour' : 'clear-day') : 'clear-night';",
        "    if (code === '45') return isDay ? 'fog-day' : 'fog-night';",
        "    if (code === '61') return isDay ? 'rain-day' : 'rain-night';",
        "    if (code === '71') return isDay ? 'snow-day' : 'snow-night';",
        "    if (code === '95') return isDay ? 'storm-day' : 'storm-night';",
        ...
        "  function renderCloudSprite(c, isNight){",
        "    var minX=0,maxX=0,minY=0,maxY=0;",
        "    c.puffs.forEach(function(p){ minX=Math.min(minX,p.dx-p.r); maxX=Math.max(maxX,p.dx+p.r); minY=Math.min(minY,p.dy-p.r+10); maxY=Math.max(maxY,p.dy+p.r+10); });",
        "    var w=Math.max(1,maxX-minX), h=Math.max(1,maxY-minY);",
        "    var off=document.createElement('canvas'); off.width=w; off.height=h;",
        "    var octx=off.getContext('2d');",
        "    var base=isNight?'rgba(150,158,178,':'rgba(255,255,255,'; var shadow=isNight?'rgba(60,66,86,':'rgba(150,160,172,';",
        "    c.puffs.forEach(function(p){ var px=p.dx-minX, py=p.dy-minY+10; var g=octx.createRadialGradient(px,py,p.r*0.1,px,py,p.r); g.addColorStop(0,shadow+'0.22)'); g.addColorStop(1,shadow+'0)'); octx.fillStyle=g; octx.beginPath(); octx.arc(px,py,p.r,0,Math.PI*2); octx.fill(); });",
        "    c.puffs.forEach(function(p){ var px=p.dx-minX, py=p.dy-minY; var g=octx.createRadialGradient(px,py,p.r*0.1,px,py,p.r); g.addColorStop(0,base+'0.95)'); g.addColorStop(1,base+'0)'); octx.fillStyle=g; octx.beginPath(); octx.arc(px,py,p.r,0,Math.PI*2); octx.fill(); });",
        "    c.sprite=off; c.spriteOffX=minX; c.spriteOffY=minY; c.spriteIsNight=isNight;",
        "  }",
        "  function drawClouds(alpha, isNight, wind, dt){",
        "    if (alpha<=0.01) return;",
        "    var mult=0.5+wind*2.2;",
        "    ctx.save(); ctx.globalAlpha = alpha;",
        "    clouds.forEach(function(c){",
        "      c.x += c.baseSpeed*mult*dt; if (c.x-260*c.scale>W) c.x=-260*c.scale;",
        "      if (!c.sprite || c.spriteIsNight !== isNight) renderCloudSprite(c, isNight);",
        "      ctx.save(); ctx.translate(c.x,c.y); ctx.scale(c.scale,c.scale);",
        "      ctx.drawImage(c.sprite, c.spriteOffX, c.spriteOffY);",
        "      ctx.restore();",
        "    });",
        "    ctx.restore();",
        "  }",
        ...
        "  var accDt = 0; var FRAME_INTERVAL = 1/18;",
        "  function frame(now){",
        "    var tickDt = Math.min((now-last)/1000, 0.05); last = now; accDt += tickDt;",
        "    if (accDt < FRAME_INTERVAL) { requestAnimationFrame(frame); return; }",
        "    var dt = accDt; accDt = 0;",
